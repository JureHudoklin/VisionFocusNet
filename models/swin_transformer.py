...
class SwinTransformerBlock(nn.Module):
    ...
    def forward(self,
        ...
        print(self.attention_mask.shape, "attention mask")
...
if __name__ == "__main__": 
    ...
    test_input = torch.rand(12, 128, 138, 138, requires_grad=True, device='cuda')
    test_input_2 = torch.rand(12, 128, 217, 224)
    
    model = SwinTransformerBlock(in_channels =128, 
                                 input_resolution=(138, 138),
                                 number_of_heads=8,
                                 window_size=6,
                                 shift_size=1).cuda()
